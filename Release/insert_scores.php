...
$auto_case_1_points = array(); // "case 1 for question 1, case 1 for question 2, ..."
...
for($i = 0; $i < count($q_ids); $i++)
{
    ...
    if(empty($current_question_for_constraint))
    {
        $auto_constraint_comments[] = NULL;
        $auto_constraint_points[] = NULL;
    }
    else if(!empty($current_question_for_constraint) && $current_question_for_constraint['points_received'] == 0)
    {
    ...
    $testcase_1 = $current_question_for_testcases[0];
    $testcase_2 = $current_question_for_testcases[1];
    $testcase_3 = $current_question_for_testcases[2];
    $testcase_4 = $current_question_for_testcases[3];
    $testcase_5 = $current_question_for_testcases[4];

    $auto_case_1_points[] = $testcase_1['case_1'];
    $auto_case_1_comments[] = $testcase_1['comments'];
    $auto_case_2_points[] = $testcase_2['case_2'];
    $auto_case_2_comments[] = $testcase_2['comments'];

    if(!empty($testcase_3) && $testcase_3['case_3'] != 0)
    {
        $auto_case_3_points[] = $testcase_3['case_3'];
        $auto_case_3_comments[] = $testcase_3['comments'];
    }
    else if(!empty($testcase_3) && $testcase_3['case_3'] == 0)
    {
        $auto_case_3_points[] = $testcase_3['case_3'];
        $auto_case_3_comments[] = $testcase_3['comments'];
    }
    ...
    {
        $auto_case_3_points[] = NULL;
        $auto_case_3_comments[] = NULL;
    }

    if(!empty($testcase_4) && $testcase_4['case_4'] != 0)
    {
        $auto_case_4_points[] = $testcase_4['case_4'];
        $auto_case_4_comments[] = $testcase_4['comments'];
    }
    else if(!empty($testcase_4) && $testcase_4['case_4'] == 0)
    {
        $auto_case_4_points[] = $testcase_4['case_4'];
        $auto_case_4_comments[] = $testcase_4['comments'];
    }
    ...
    {
        $auto_case_4_points[] = NULL;
        $auto_case_4_comments[] = NULL;
    }

    if(!empty($testcase_5) && $testcase_5['case_5'] != 0)
    {
        $auto_case_5_points[] = $testcase_5['case_5'];
        $auto_case_5_comments[] = $testcase_5['comments'];
    }
    else if(!empty($testcase_5) && $testcase_5['case_5'] == 0)
    {
        $auto_case_5_points[] = $testcase_5['case_5'];
        $auto_case_5_comments[] = $testcase_5['comments'];
    }
    ...
    {
        $auto_case_5_points[] = NULL;
        $auto_case_5_comments[] = NULL;
    }
}
...
for($i = 0; $i < count($questions); $i++) // for 1 exam, N question ids, N answer ids, N responses, ...
{
    ...
    $current_question_constraint_autograde_points = NULL;
    $current_question_constraint_autograde_comment = NULL;

    $current_question_case_3_autograde_points = NULL;
    $current_question_case_3_autograde_comment = NULL;
    $current_question_case_4_autograde_points = NULL;
    $current_question_case_4_autograde_comment = NULL;
    $current_question_case_5_autograde_points = NULL;
    $current_question_case_5_autograde_comment = NULL;

    if(isset($auto_case_3_points[$i]))
        $current_question_case_3_autograde_points = $auto_case_3_points[$i];
    if(isset($auto_case_3_comments[$i]))
        $current_question_case_3_autograde_comment = $auto_case_3_comments[$i];

    if(isset($auto_case_4_points[$i]))
        $current_question_case_4_autograde_points = $auto_case_4_points[$i];
    if(isset($auto_case_4_comments[$i]))
        $current_question_case_4_autograde_comment = $auto_case_4_comments[$i];

    if(isset($auto_case_5_points[$i]))
        $current_question_case_5_autograde_points = $auto_case_5_points[$i];
    if(isset($auto_case_5_comments[$i]))
        $current_question_case_5_autograde_comment = $auto_case_5_comments[$i];

    if(isset($auto_constraint_points[$i]))
        $current_question_constraint_autograde_points = $auto_constraint_points[$i];
    if(isset($auto_constraint_comments[$i]))
    ...
    $current_question_constraint_edit_points = NULL;
    $current_question_case_3_edit_points = NULL;
    $current_question_case_4_edit_points = NULL;
    $current_question_case_5_edit_points = NULL;

    if(isset($edited_constraint_points[$i]))
        $current_question_constraint_edit_points = $edited_constraint_points[$i];

    if(isset($edited_testcase3_check_points[$i]))
        $current_question_case_3_edit_points = $edited_testcase3_check_points[$i];

    if(isset($edited_testcase4_check_points[$i]))
        $current_question_case_4_edit_points = $edited_testcase4_check_points[$i];

    if(isset($edited_testcase5_check_points[$i]))
